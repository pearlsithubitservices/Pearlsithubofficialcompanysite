...
import CareerApplicationForm from './Applicationform/page';
...
export default function App() {
  ...
  useEffect(() => {
    document.body.classList.toggle("overflow-hidden", openForm);
    document.documentElement.classList.toggle("overflow-hidden", openForm);
  ...
  const jobs = CareerData[category] || [];
              ...
              {jobs.map((job, index) => (
                ...
                >
                  ...
                  <div className="space-y-6 relative z-10">
                    ...
                    <div className="pt-6">
                      <button className="flex items-center gap-3 font-black cursor-pointer uppercase tracking-widest text-xs text-tcs-blue group/btn"
                        onClick={() => {
                          setOpenForm(true)
                          setSelectedContent(job)
                        }}
                      >
                        Apply Now
        ...
        {openForm && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-5xl h-screen rounded-2xl overflow-hidden  "
            >
              <div className="h-full overflow-y-auto   p-10"
                onClick={(e) => e.stopPropagation()}>
                <CareerApplicationForm
                  position={selectedContent}
